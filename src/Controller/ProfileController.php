...
class ProfileController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/edit", name="app_profile_edit", methods={"GET", "POST"}, requirements={"id":"\d+"})
     */
    public function edit(Profile $profile, Request $request, ProfileRepository $profileRepository): Response
    {
        $form = $this->createForm(ProfileType::class, $profile);
        $form->handleRequest($request);
